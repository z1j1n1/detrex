...
commands = open("commands_flops_addon.sh","w")
...
for line in fp.readlines():
    ...
    commands.write(f"python tools/analyze_model.py --config-file {config_dir} --tasks parameter >> './eval_params_addon/{model_name}.txt'\n")