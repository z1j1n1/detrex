...
def default_X_scheduler(num_X):
    ...
    """
    # total number of iterations assuming 4 batch size, using 15000/4=3750
    total_steps_4bs = num_X * 3750
    ...
    if num_X <= 2:
        ...
        scheduler = L(MultiStepParamScheduler)(
            values=[1.0, 0.1, 0.01],
            milestones=[total_steps_4bs - 2500, total_steps_4bs - 3500, total_steps_4bs],
        )
    return L(WarmupParamScheduler)(
        scheduler=scheduler,
        warmup_length=1000 / total_steps_4bs,
...
def default_coco_scheduler(epochs=50, decay_epochs=40, warmup_epochs=0):
    ...
    Returns:
        DictConfig: configs that define the multiplier for LR during training
    """
    # total number of iterations assuming 16 batch size, using 15000/8=1875
    total_steps_16bs = epochs * 1875
    decay_steps = decay_epochs * 1875
    warmup_steps = warmup_epochs * 1875
    scheduler = L(MultiStepParamScheduler)(
        values=[1.0, 0.1],
